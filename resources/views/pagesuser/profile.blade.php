...
<div class="col-lg-6 col-sm-6">
    <div class="card hovercard">
        ...
        <div class="useravatar">
            @if(isset($user->info->image))<img alt="" src="/storage/cover_image/{{$user->info->image}}">  @elseif($user->sign =='t') <img alt="" src="{{asset('images/noimage.png')}}">@else  <img alt="" src="{{asset('images/noimage1.png')}}">@endif
            
        </div>
        <div class="card-info"> <span class="card-title" style="color:#fff;">@if($user->sign=='t')Teacher :{{$user->name}}@else Student :{{$user->name}}@endif </span>
    ...
    <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="..." style="width:800px;">
        ...
        <div class="btn-group" role="group">
            <button type="button" id="favorites" class="btn btn-default" href="#tab2" data-toggle="tab"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                <div class="hidden-xs">@if($user->sign == 't') Student @else My Teacher @endif </div>
            </button>
        </div>
        <div class="btn-group" role="group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">@if($user->sign == 't') Teacher @else Student @endif</h3>
            </div>
        ...
        @if($use->sign == Auth::user()->sign)
           <div class="containerb" style="float: left;width:232px;margin-right:20px;height:400px; ">
              <div class="avatar-flip">
                ...
                @elseif(Auth::user()->sign=='t')  <img src="{{asset('images/noimage.png')}}" height="150" width="150">
                @else
